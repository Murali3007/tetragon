...
[File Access Monitoring](/tetragon/docs/getting-started/d/file-events) section of the Getting Started guide.
To see a network policy check the [Networking Monitoring](/tetragon/docs/getting-started/d/network) section.
