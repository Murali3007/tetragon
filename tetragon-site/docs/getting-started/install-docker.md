...
the [recommended kernel versions](https://github.com/cilium/tetragon/tree/main/docs/installation/faq#what-is-the-minimum-linux-kernel-version-to-run-tetragon).
...
programs. See the [Installation and Configuration](https://github.com/cilium/tetragon/tree/main/docs/installation)
section for more details.

## Run demo application

To explore Tetragon it is helpful to have a sample workload. You can use Ciliumâ€™s
...
7b60618ca8bd   quay.io/cilium/starwars:v2.1      "/starwars-docker --â€¦"   34 seconds ago   Up 33 seconds   0.0.0.0:8080->80/tcp, :::8080->80/tcp   starwars-deathstar-1
```

## What's next

Check for [execution events](/tetragon/docs/getting-started/d/execution).
