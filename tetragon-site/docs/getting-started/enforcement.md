...
For specific implementation details refer to the [Enforcement](https://github.com/cilium/tetragon/tree/main/docs/concepts/enforcement)
concept section.
...
[Quick Kubernetes Install](https://github.com/cilium/tetragon/tree/main/docs/getting-started/install-k8s) section.

The policy you will use is very similar to the policy you used in the
[Network Monitoring](https://github.com/cilium/tetragon/tree/main/docs/getting-started/network) section, but
...
The following extends the example from [File Access Monitoring](https://github.com/cilium/tetragon/tree/main/docs/getting-started/file-events)
...
* To explore details of writing and implementing policies the [Concepts](https://github.com/cilium/tetragon/tree/main/docs/concepts)
is a good jumping off point.
* For installation into production environments we recommend reviewing
[Advanced Installations](https://github.com/cilium/tetragon/tree/main/docs/installation).
* Finally the [Use Cases](https://github.com/cilium/tetragon/tree/main/docs/use-cases) section covers different
