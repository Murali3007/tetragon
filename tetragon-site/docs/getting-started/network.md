...
ðŸ’¥ exit    default/xwing /usr/bin/curl -s -XPOST deathstar.default.svc.cluster.local/v1/request-landing 0 
```
...
[enforcement](/tetragon/docs/getting-started/d/enforcement) to the policies
...
[Concepts](https://github.com/cilium/tetragon/tree/main/docs/concepts) section.
